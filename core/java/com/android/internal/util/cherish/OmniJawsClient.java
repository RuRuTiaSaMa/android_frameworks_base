...
public class OmniJawsClient {
    ...
    private static final String AE_SETTINGSACTIVITY = "com.power.hub.SettingsActivity";
    private static final String SETTINGS_PACKAGE_NAME = "com.power.hub";
    private static final String WEATHER_SETTINGS = "com.power.hub.fragments.Weather";
